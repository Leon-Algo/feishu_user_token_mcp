...
def create_server():
    ...
    @server.tool()
    def get_feishu_app_token(app_id: str, app_secret: str) -> dict:
        """
        ...
        """
        print(f"[DEBUG] Tool called with app_id: {app_id[:8]}...")
        print(f"[DEBUG] Tool called with app_secret length: {len(app_secret)}")
